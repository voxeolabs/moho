...
public class SIPSubscribeEventImpl extends SIPSubscribeEvent {

  protected SIPSubscribeEventImpl(final ApplicationEventSource source, final SipServletRequest req) {
    super(source, req);
  }
