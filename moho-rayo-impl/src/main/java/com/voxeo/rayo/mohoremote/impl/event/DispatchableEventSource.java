...
import com.voxeo.rayo.mohoremote.impl.utils.Utils;
...
public class DispatchableEventSource extends AttributeStoreImpl implements EventSource {
  ...
  public DispatchableEventSource() {
    _id = UUID.randomUUID().toString(); // TODO: better one?
  }

  public DispatchableEventSource(final String id, final Executor executor, boolean orderedDispatch) {
    _id = id;
    _dispatcher.setExecutor(executor, orderedDispatch);
  }
